...
/** @file ha_nakamori.h
  ...
  /storage/nakamori/ha_nakamori.cc.

    @note
  Please read ha_nakamori.cc before reading this file.
  Reminder: The nakamori storage engine implements all methods that are
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.

   @see
  /sql/handler.h and /storage/nakamori/ha_nakamori.cc
*/
...
*/
class Nakamori_share : public Handler_share {
 public:
  THR_LOCK lock;
  Nakamori_share();
...
class ha_nakamori : public handler {
 ...
 public:
   ...
   */
  const char *table_type() const override { return "NAKAMORI"; }
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_nakamori.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_nakamori.cc; it's a required method.
  */
